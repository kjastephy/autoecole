          ...
          <div id="users-list" class="list-group">
            <div class="users-list-padding media-list">
              ...
              foreach($resultat as $ligne){
                ...
                $action="JavaScript:showmail('{$objet}','{$nom}','{$email}','{$image}','{$contenu}');";?>

                <a href="<?php echo $action ?>" class="media bg-blue-grey bg-lighten-5 border-right-primary border-right-2">
                  <div class="media-left pr-1">
                    <span class="avatar avatar-md">
                      <span class="media-object rounded-circle text-circle bg-warning"><?php echo substr(strtoupper($ligne->nom), 0, 1) ?></span>
                    </span>
                  </div>
                  <div class="media-body w-100">
                    ...
                    <p class="list-group-item-text mb-0"><?php echo substr($ligne->contenu, 0, 12) ?>...<span class="float-right primary"><span class="badge badge-warning mr-1"><?php echo $ligne->lu ?></span> <i class="font-medium-1 ft-star blue-grey lighten-3"></i></span></p>
                  </div>
                </a>
