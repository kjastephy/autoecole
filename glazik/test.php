...
<body class="vertical-layout vertical-menu-modern content-left-sidebar   menu-expanded fixed-navbar" data-open="click" data-menu="vertical-menu-modern" data-col="content-left-sidebar">
  ...
  <?php include_once('contenu_mail.php'); ?>
